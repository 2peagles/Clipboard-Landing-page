import imagecomputer from './Images/imagecomputer.png';
import imagedevices from './Images/imagedevices.png';
import logogoogle from './Images/logogoogle.png';
import logoibm from './Images/logoibm.png';
import logomicrosoft from './Images/logomicrosoft.png';
import logohp from './Images/logohp.png';
import logovectorgraphic from './Images/logovectorgraphics.png';
import './App.css';
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <svg width="125" height="125" xmlns="http://www.w3.org/2000/svg"><g stroke="#26BBA4" stroke-width="10" fill="none" fill-rule="evenodd">
            <circle cx="62.5" cy="62.5" r="57.5"/>
              ...
              <p>Clipboard allows you tot track and organize everything 
               you copy. Instantly access your clipboard on all your devices.
            </p>
          <button id='btnios'>Download for iOS</button>
        <button id='btnmac'>Download for Mac</button>
        </article>
      </header>
      <main>
        <article id='sectiontwo'>
          <div className="sectiontwo-begin-content">
        ...
        <article id='sectionthree'>
          <h3>Access Clipboard Anywhere</h3>
          <p>Where you're on the go, or at your computer, you can access all your Clipboard snippets in 
            a few simple clicks.
          </p>
          <img  src={imagedevices} alt="desktop view" className="mobileimage"/>
          ...
          <svg width="44" height="40" xmlns="http://www.w3.org/2000/svg"><g fill="#9EABB2" fill-rule="nonzero"><path d="M11.07 0C8.353 0 6.14 2.192 6.14 4.876l-.179 25.278 2.69.02.179-25.289c0-1.21 1.005-2.196 2.24-2.196h27.027V0H11.071z"/><path d="M38.097 0a5.115 5.115 0 00-5.11 5.11v28.37c0 2.052-1.668 3.72-3.72 3.72a3.725 3.725 0 01-3.72-3.72V30.21c0-.743-.601-1.345-1.344-1.345H1.345C.602 28.864 0 29.466 0 30.21v3.272a6.417 6.417 0 006.41 6.409V37.2a3.724 3.724 0 01-3.72-3.72v-1.927h20.168v1.928a6.417 6.417 0 006.41 6.409 6.417 6.417 0 006.409-6.41V12.46h6.185c.743 0 1.345-.602 1.345-1.345V5.11A5.115 5.115 0 0038.097 0zm2.42 9.77h-4.84V5.11a2.423 2.423 0 012.42-2.42 2.423 2.423 0 012.42 2.42v4.66z"/><path d="M6.14 37.201h22.813v2.689H6.14zM19.99 7.485h-6.947a1.345 1.345 0 100 2.69h6.947a1.345 1.345 0 100-2.69zM28.057 12.863H13.043a1.345 1.345 0 100 2.69h15.014a1.345 1.345 0 100-2.69zM28.057 18.242H13.043a1.345 1.345 0 100 2.69h15.014a1.344 1.344 0 100-2.69zM28.057 23.62H13.043a1.345 1.345 0 100 2.69h15.014a1.345 1.345 0 100-2.69z"/></g></svg>
              <li>Create blacklists</li>
              <ol>
                <li>Ensure sensitive information never makes its way to your clipboard by excluding
                  certain sources.
                </li>
              </ol>
              ...
              <li>Plain text snippers</li>
              <ol>
                <li>Remove unwanted formatting from copied text for a consistent look.</li>
              </ol>
              ...
              <li>Sneak preview</li>
              <ol>
                <li>Quick preview of all snnipets on you Clipboard for easy access.</li>
              </ol>
          </ol>
        </article>
        <article id="sectionfour">
          <ol>
            <li><img src={logogoogle} alt="google logo"/></li>
            <li><img src={logoibm} alt="ibm logo"/></li>
            <li><img src={logomicrosoft} alt="microsoft logo"/></li>
            <li><img src={logohp} alt="hp logo"/></li>
            <li><img src={logovectorgraphic} alt="vector graphic logo"/></li>
          </ol>
        </article>
        <article id="sectionfive">
      ...
      <footer>
        ...
        <ol id='social-icons'>
          <li><svg className="svg" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M22.675 0H1.325C.593 0 0 .593 0 1.325v21.351C0 23.407.593 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.323-.593 1.323-1.325V1.325C24 .593 23.407 0 22.675 0z" fill="#4C545C" fill-rule="nonzero"/></svg></li>
          <li><svg width="24" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M24 2.557a9.83 9.83 0 01-2.828.775A4.932 4.932 0 0023.337.608a9.864 9.864 0 01-3.127 1.195A4.916 4.916 0 0016.616.248c-3.179 0-5.515 2.966-4.797 6.045A13.978 13.978 0 011.671 1.149a4.93 4.93 0 001.523 6.574 4.903 4.903 0 01-2.229-.616c-.054 2.281 1.581 4.415 3.949 4.89a4.935 4.935 0 01-2.224.084 4.928 4.928 0 004.6 3.419A9.9 9.9 0 010 17.54a13.94 13.94 0 007.548 2.212c9.142 0 14.307-7.721 13.995-14.646A10.025 10.025 0 0024 2.557z" fill="#4C545C" fill-rule="nonzero"/></svg></li>
          <li><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" fill="#4C545C" fill-rule="nonzero"/></svg></li>
        </ol>
      </footer>
    </div>
  );
